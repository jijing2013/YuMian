...
//    _leftImageView.image = [UIImage imageNamed:leftName];
    [_leftImageView sd_setImageWithURL:[NSURL URLWithString:leftName]placeholderImage:[UIImage imageNamed:@"default.jpg"] options:SDWebImageLowPriority | SDWebImageRetryFailed | SDWebImageProgressiveDownload];
    NSString * centerName = self.dataList[_currentPage];
//    _centerImageView.image = [UIImage imageNamed:centerName];
    [_centerImageView sd_setImageWithURL:[NSURL URLWithString:centerName]placeholderImage:[UIImage imageNamed:@"default.jpg"] options:SDWebImageLowPriority | SDWebImageRetryFailed | SDWebImageProgressiveDownload];
    
    NSString * rightName = self.dataList[(_currentPage + 1) % _totalPage];
//    _rightImageView.image = [UIImage imageNamed:rightName];
    [_rightImageView sd_setImageWithURL:[NSURL URLWithString:rightName]placeholderImage:[UIImage imageNamed:@"default.jpg"] options:SDWebImageLowPriority | SDWebImageRetryFailed | SDWebImageProgressiveDownload];
